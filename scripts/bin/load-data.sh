...
pypgstac load collections /tmp/data/covid-eo-blackmarble-collection.json --dsn postgresql://username:password@0.0.0.0:5432/postgis --method upsert
...
pypgstac load items /tmp/data/covid-eo-blackmarble-items.json --dsn postgresql://username:password@0.0.0.0:5432/postgis --method upsert
