...
import pytest
from src.core import ExtendedSearchRequest, VedaCrudClient
...
class TestSearchBase:
    ...
    async def test_tiler_url_overrides(self):
        ...
        valid_stac_collection_renders_with_dashboard = {
            ...
            "links": [],
            "stac_version": "1.0.0",
            "renders": {"dashboard": {"nodata": -9999, "assets": ["burnRatio"]}},
        }
