...
class vedaAppSettings(BaseSettings):
    ...
    @property
    def stac_catalog_url(self) -> str | None:
        """
        Infer stac catalog url based on whether the app is configured
        to deploy the catalog to a custom subdomain or to a cloudfront route
        """
